...
// Creates different types of elements
...
// Sets properties on created elements
...
// Adds spacing styles for demo elements
...
function createTaskElement(task) {
    ...
    // Appends spans to list item
    listItem.appendChild(taskTextSpan);
    listItem.appendChild(statusSpan);

    // Adds click event for toggling completion
...
// Adds enter key functionality for input using simple event handling
